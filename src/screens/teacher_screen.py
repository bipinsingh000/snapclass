                            ...
                            results.append(
                                {
                                    ...
                                    "Sources":", ".join(map(str, sources))  if is_present else "-",
...
def teacher_tab_manage_subjects():
    ...
    if subjects:
        ...
        st.warning("No subjects found, create subject above")
...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username = st.text_input("Enter your username",placeholder="bipinsingh")
...
def teacher_screen_register():
    ...
    st.space()
    teacher_username = st.text_input("Enter your username",placeholder="bipinsingh")
    teacher_name = st.text_input("Enter your name",placeholder="Bipin Singh")
    teacher_password = st.text_input("Enter your password",type="password",placeholder="Enter your password")
    teacher_confirm_password = st.text_input("Confirm your password",type="password",placeholder="Confirm your password")
    st.divider()
